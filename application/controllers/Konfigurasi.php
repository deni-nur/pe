...
class Konfigurasi extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('template', 'home/web_data', $data);
	}
	...
	public function add()
	{
		...
		$this->template->load('template', 'home/web_add', $data);
		// masuk database
		} else {
			...
			redirect(base_url('portal/'.$portal_id=$this->uri->segment(2).'/konfigurasi'), 'refresh');
		// end masuk database
	}}
	$data = array(	'page'			=> 'add',
					'konfigurasi'	=> $konfigurasi,
	...
	{
		$konfigurasi_id = $this->uri->segment(5);
		...
		$this->template->load('template', 'home/web_edit', $data);
		// Masuk Database
		} else {
			// proses manipulasi gambar
			$upload_data		= array('uploads' =>$this->upload->data());
	...
	public function del_konfigurasi()
	{
		...
		$this->konfigurasi_m->del_konfigurasi(['konfigurasi_id' => $konfigurasi_id]);
