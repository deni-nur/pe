...
// form open
echo form_open_multipart(base_url('portal/'.$this->uri->segment(2).'/konfigurasi/edit/'.$konfigurasi->konfigurasi_id));
?>
    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?=site_url('portal/'.$this->uri->segment(2).'/konfigurasi') ?>" class="btn btn-warning btn-flat">
