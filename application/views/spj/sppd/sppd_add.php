...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/sppd/add'),' class="form-horizontal"');
?>
              ...
              <label>Tanggal Berangkat</label>
                <div class="input-group date">
                  <div class="input-group-addon">
                    ...
                    <input type="text" name="tgl_berangkat" class="form-control" id="datepicker1">
                </div>
              </div>
              <div class="form-group">
              <label>Tanggal Kembali</label>
                <div class="input-group date">
                  <div class="input-group-addon">
                    ...
                    <input type="text" name="tgl_pulang" class="form-control" id="datepicker2">
                </div>
              </div>
              <div>
              ...
              <div class="form-group">
                  ...
                  <select name="ttd_keu_id" class="form-control" required>
                      ...
                      <?php foreach ($ttd_keu->result() as $ttd_keu) { ?>
                        <option value="<?=$ttd_keu->ttd_keu_id ?>"><?=$ttd_keu->ttd_keu_name ?></option>
                      <?php } ?>
                  </select>
              </div>
