...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/sppd/edit/'.$sppd->sppd_id),' class="form-horizontal"');
?>
...
<div class="box">
    <div class="box-header">
        ...
        <div class="pull-right">
            <a href="<?=base_url('portal/'.$this->uri->segment(2).'/sppd') ?>" class="btn btn-warning btn-flat">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
              <div class="form-group">
                  ...
                  <input type="hidden" name="st_id" id="st_id" value="<?=$sppd->st_id ?>">
              ...
              <label>Tanggal Berangkat</label>
                <div class="input-group date">
                  <div class="input-group-addon">
                    ...
                    <input type="text" name="tgl_berangkat" value="<?=$sppd->tgl_berangkat ?>" class="form-control" id="datepicker1">
                </div>
              </div>
              <div class="form-group">
              <label>Tanggal Kembali</label>
                <div class="input-group date">
                  <div class="input-group-addon">
                    ...
                    <input type="text" name="tgl_pulang" value="<?=$sppd->tgl_pulang ?>" class="form-control" id="datepicker2">
                </div>
              </div>
              <div>
              ...
              <div class="form-group input-group">
                  <input type="hidden" name="belanja_id" id="belanja_id" value="<?=$sppd->belanja_id ?>">
              ...
              <div class="form-group">
                  ...
                  <select name="ttd_keu_id" class="form-control" required>
                      <option value="">- Pilih -</option>
                      <?php foreach ($ttd_keu->result() as $ttd_keu) { ?>
                        <option value="<?=$ttd_keu->ttd_keu_id ?>" <?=$ttd_keu->ttd_keu_id == $sppd->ttd_keu_id ? "selected" : null ?>><?=$ttd_keu->ttd_keu_name ?></option>
                      <?php } ?>
                  </select>
              </div>
            ...
            <?php 
              ...
              foreach($belanja->result() as $key1 => $data_belanja) {
                  if(!empty($data_dpa->dpa_id == $data_belanja->dpa_id)) { 
                      ...
                      if($a==1) { ?>
            <tr>
              <th colspan="6">[SUB KEGIATAN] <?=$data_belanja->nama_subkeg ?></th>
            </tr>
            <?php } ?>
        </thead>
        <tbody>
