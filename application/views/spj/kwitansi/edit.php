...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/kwitansi/'.$this->uri->segment(4).'/belanja/'.$this->uri->segment(6).'/edit/'.$kwitansi->kwitansi_id),' class="form-horizontal"');
?>
    ...
    <div class="row">
      <div class="col-md-4 col-md-offset-4">
          ...
          <div class=" input-group">
              ...
              <input type="hidden" name="r_pp_id" value="<?=$kwitansi->r_pp_id ?>" id="r_pp_id" class="form-control" required>
