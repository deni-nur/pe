...
<section class="content">
	...
	<div class="box">
		<div class="box-header">
			...
			<a href="<?=site_url('portal/'.$this->uri->segment(2).'/kwitansi') ?>" class="btn btn-warning btn-flat">
			...
			<table class="table table-bordered table-striped" id="table1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=indo_currency($data_belanja->jumlah_biaya) ?></td>
                        <td>
                            <a href="<?=site_url('portal/'.$this->uri->segment(2).'/kwitansi/'.$data_belanja->pp_id.'/belanja/'.$data_belanja->belanja_id.'/data') ?>" class="btn btn-info btn-xs">
