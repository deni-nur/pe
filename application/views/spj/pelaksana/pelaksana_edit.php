...
// form open
echo form_open(base_url('st/pelaksana/'.$st->st_id.'/edit/'.$pelaksana->pelaksana_id),' class="form-horizontal"');
?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="pegawai_id" class="form-control" required>
                            ...
                            <?php foreach($pegawai as $key => $data) { ?>
                                <option value="<?php echo $data->pegawai_id ?>"<?php if($pelaksana->pegawai_id==$data->pegawai_id) { echo "selected"; } ?>>
                                    <?php echo $data->name ?>
                                </option>
                            <?php } ?>
                        </select>
