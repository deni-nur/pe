...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pp/edit/'.$pp->pp_id),' class="form-horizontal"');
?>
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <!--        </div>-->
                    <!--        <input type="date" name="tgl_pp" value="<?=$pp->tgl_pp ?>" class="form-control" required>-->
                    <!--        </div>-->
                    <!--    </div>-->
                    <!--<div>-->
                    <div class="form-group">
                        ...
                        <select name="dpa_id" class="form-control" required>
                            ...
                            <option value="<?=$data->dpa_id ?>" <?=$data->dpa_id == $pp->dpa_id ? "selected" : null ?>><?=$data->nama_subkeg ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group input-group">
                        <input type="text" name="nama_pa" value="<?=$pp->nama_pa ?>" id="nama_pa" class="form-control" required>
                        <input type="hidden" name="nip_pa" value="<?=$pp->nip_pa ?>" id="nip_pa" class="form-control" required>
                        <input type="hidden" name="jabatan_pa" value="<?=$pp->jabatan_pa ?>" id="jabatan_pa" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="ttd_keu_id" class="form-control" required>
                            ...
                            <option value="<?=$data->ttd_keu_id ?>" <?=$data->ttd_keu_id == $pp->ttd_keu_id ? "selected" : null ?>><?=$data->ttd_keu_name ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group input-group">
                        <input type="text" name="nama_bpp" value="<?=$pp->nama_bpp ?>" id="nama_bpp" class="form-control" required>
                        <input type="hidden" name="nip_bpp" value="<?=$pp->nip_bpp ?>" id="nip_bpp" class="form-control" required>
                        <input type="hidden" name="jabatan_bpp" value="<?=$pp->jabatan_bpp ?>" id="jabatan_bpp" class="form-control" required>
                        <span class="input-group-btn">
