...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pp/'.$this->uri->segment(4).'/r_pp_add'),' class="form-horizontal"');
?>
...
<div class="box">
	<div class="box-header">
		<h3 class="box-title"><?=ucfirst($page) ?> Rincian Permintaan Pembayaran</h3>
			...
			<div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="date" name="tgl_rpp" value="<?=date('Y-m-d') ?>" class="form-control" required>
                            </div>
                        </div>
                    <div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="uraian" id="maksud" rows="5" class="form-control" required autofocus></textarea>
                    ...
                    <div class="form-group input-group">
                        ...
                        <input type="text" name="rek_bank" id="rek_bank" class="form-control" required autofocus readonly>
                        <span class="input-group-btn">
