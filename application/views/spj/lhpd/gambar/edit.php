...
// form open
echo form_open_multipart(base_url('portal/'.$this->uri->segment(2).'/lhpd/'.$lhpd->lhpd_id.'/gambar_edit/'.$gambar_lhpd->gambar_lhpd_id));
?>
	...
	<div class="box">
		<div class="box-header">
			...
			<div class="pull-right">
				<a href="<?=site_url('portal/'.$this->uri->segment(2).'/lhpd/'.$lhpd->lhpd_id.'/gambar_data') ?>" class="btn btn-warning btn-flat">
