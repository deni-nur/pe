...
<table border="1" cellspacing="0">
    <thead>
        <tr>
            ...
            <td valign="top"> Surat Perintah Tugas Nomor : <?=$datalhpd->no_st ?></td>
        </tr>
        <tr>
...
<table border="1" cellspacing="0">
    <thead>
        <tr>
            ...
            <th style="text-align: center;" width="1%" valign="top">:</th>
            <td valign="top"><?=$datalhpd->hari ?></td>
        </tr>
        <tr>
            <th style="text-align: left;" valign="top">Tanggal</th>
            <th valign="top">:</th>
            <td valign="top"><?=format_indo($datalhpd->tgl_kegiatan) ?></td>
        </tr>
        <tr>
            <th style="text-align: left;" valign="top">Waktu</th>
            <th valign="top">:</th>
            <td valign="top"><?=$datalhpd->waktu ?></td>
        </tr>
        <tr>
            <th style="text-align: left;" valign="top">Tempat</th>
            <th valign="top">:</th>
            <td valign="top"><?=$datalhpd->tempat ?></td>
        </tr>
        <tr>
...
<table border="1" cellspacing="0" width="100%">
  <thead>
    <?php foreach($gambar_lhpd as $key => $data) { ?>
    <tr>
...
<table>
  <thead>
    ...
    <tr>
      ...
      <td width="15%" style="text-align: center;"><?=$datalhpd->alamat ?>, <?=format_indo($datalhpd->tgl_lhpd) ?></td>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      <td colspan="3"></td>
      <td align="center"><b><?=$datalhpd->name ?></b></td>
    </tr>
    <?php if(!empty($datalhpd->pangkat and $datalhpd->gol and $datalhpd->nip)) { ?>
    <tr>
      <td colspan="3"></td>
      <td align="center"><?=$datalhpd->pangkat ?> <?=$datalhpd->gol ?></td>
    </tr>
    <tr>
      <td colspan="3"></td>
