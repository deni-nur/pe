...
// form open
echo form_open_multipart(base_url('portal/'.$this->uri->segment(2).'/ttd/add'),' class="form-horizontal"');
?>
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
                        ...
                        <label>Jabatan Dalam Penandatangan </label>
                        	<input type="text" name="jabatan_ttd" class="form-control" placeholder="Boleh di KOSONGKAN">
                        </div>
                        <div class="form-group">
