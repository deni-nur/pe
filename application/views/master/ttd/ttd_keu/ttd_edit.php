...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/ttd_keu/edit/'.$ttd_keu->ttd_keu_id),' class="form-horizontal"');
?>
				...
				<div class="col-md-4 col-md-offset-4">
                        ...
                        <select name="pegawai_id" class="form-control" >
							...
							<?php foreach($pegawai->result() as $pegawai) { ?>
								<option value="<?=$pegawai->pegawai_id?>"<?php if($ttd_keu->pegawai_id==$pegawai->pegawai_id) { echo "selected"; } ?>><?=$pegawai->name?></option>
							<?php } ?>
						</select>
                        </div>
                        ...
                        <label>Jabatan Dalam Penandatangan *</label>
                        	<textarea name="jabatan_ttd_keu" class="form-control" rows="3" required><?=$ttd_keu->jabatan_ttd_keu ?></textarea>
                        </div>
