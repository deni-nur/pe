    ...
    <section class="content">
    	<div class="box">
    		<div class="box-header">
    			...
    			<div class="pull-right">
    				<a href="<?=site_url('portal/'.$this->uri->segment(2).'/pegawai') ?>" class="btn btn-warning btn-flat btn-sm">
    		...
    		<div class="box-body">
				...
				<?=$row->nip?>
				<br><br>
				<a href="<?=site_url('portal/'.$this->uri->segment(2).'/pegawai/nip_barcode_print/'.$row->pegawai_id) ?>" target="_blank" class="btn btn-default btn-sm">
    	...
    	<div class="box">
    		...
    		<div class="box-body">
				...
				<?=$row->nip?>
				<br><br>
				<a href="<?=site_url('portal/'.$this->uri->segment(2).'/pegawai/nip_qrcode_print/'.$row->pegawai_id) ?>" target="_blank" class="btn btn-default btn-sm">
					<i class="fa fa-print"></i> Print
				</a>
    		</div>
    	</div>
