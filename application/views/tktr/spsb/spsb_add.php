...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/spsb/add'),' class="form-horizontal"');
?>
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_spsb" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Federasi/Komfed </label>
                            <input type="text" name="federasi" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Jumlah PUK/PK/SP *</label>
                            <input type="number" name="jml_puk" class="form-control" required>
                        </div>
                        <div class="form-group">
