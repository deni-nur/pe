...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pelatihan/add'),' class="form-horizontal"');
?>
			...
			<div class="row">
						...
						<div class="col-md-6">
                            ...
                            <select name="sumber_dana" class="form-control" required>
                                ...
                                <option value="<?=$sumber_dana[$c] ?>"> <?=$sumber_dana[$c] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select name="kejuruan" class="form-control" required>
                                ...
                                for($c=0; $c<$jlh_bln; $c+=1){ ?>
                                <option value="<?=$kejuruan[$c] ?>"> <?=$kejuruan[$c] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="tanggal_lahir" value="<?=date('Y-m-d') ?>" class="form-control" required>
                        </div>
                        <div class="col-md-6">
