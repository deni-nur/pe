...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pmi_kasus/add'),' class="form-horizontal"');
?>
		...
		<div class="box-body">
			<div class="row">
						...
						<div class="col-md-6">
                            ...
                            <input type="date" name="tanggal_laporan" value="<?=date('Y-m-d') ?>" class="form-control" required>
                        </div>
                        <div class="col-md-6">
                            <label>Nama PMI *</label>
                            <input type="text" name="nama_pmi" class="form-control" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="negara_penempatan" class="form-control" required>
                                ...
                                <option value="<?=$negara_penempatan[$c] ?>"> <?=$negara_penempatan[$c] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col-md-6">
