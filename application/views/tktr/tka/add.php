...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/tka/'.$this->uri->segment(4).'/add'),' class="form-horizontal"');
?>
		...
		<div class="box-body">
			<div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_tka" class="form-control" required>
                        </div>
                        <div class="col-md-6">
						...
						<div class="col-md-6">
                            ...
                            <select name="kebangsaan" class="form-control" required>
                                ...
                                for($c=0; $c<$jlh_bln; $c+=1){ ?>
                                <option value="<?=$kebangsaan[$c] ?>"> <?=$kebangsaan[$c] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="kitas" class="form-control" required>
                        </div>
                        <div class="col-md-6">
                            <label>Jabatan *</label>
