    	...
    	<div class="box">
    		<div class="box-header">
    			...
    			<div class="pull-right">
    				<a href="<?=site_url('portal/'.$this->uri->segment(2).'/user') ?>" class="btn btn-warning btn-flat">
    					...
    					<form action="" method="post">
                            ...
                            <div class="form-group <?=form_error('is_active') ? 'has-error' : null ?>">
                                ...
                                <select name="is_active" class="form-control">
                                    <?php $is_active = $this->input->post('is_active') ? $this->input->post('is_active') :  $row->is_active ?>
                                    <option value="1">Aktif</option>
                                    <option value="0" <?=$is_active == 0 ? 'selected' : null ?>>Non Aktif</option>
                                </select>
