            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <label for="indikator">Indikator *</label>
                        <textarea name="" id="uraian_indikator_subkeg" class="form-control" readonly></textarea>
                    </div>

                    <div class="form-group">
                    <label for="target">Target *</label>
                        <input type="text" name="target" id="" class="form-control" required>
                    </div>

                    <div class="form-group">
                    <label for="satuan">Satuan *</label>
                        <input type="text" name="" id="satuan" class="form-control" readonly>
                    </div>
