...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/dpa/'.$this->uri->segment(4).'/belanja_perubahan/'.$belanja->belanja_id),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        ...
                        <select name="sub_rincian_objek_id" class="form-control" required readonly>
                    ...
                    <div class="form-group">
                        <label>Pagu Anggaran Murni *</label>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input type="number" name="pagu_pergeseran" value="<?=$belanja->pagu_pergeseran ?>" class="form-control" required readonly>
                    </div> -->
                    <div class="form-group">
                        <label>Pagu Anggaran Perubahan *</label>
                        <input type="number" name="pagu_perubahan" value="<?=$belanja->pagu_perubahan ?>" class="form-control" required>
                    </div>
