...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/dpa/'.$this->uri->segment(4).'/belanja_edit/'.$belanja->belanja_id),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="pagu_belanja" value="<?=$belanja->pagu_belanja ?>" class="form-control" required>
                    </div>
