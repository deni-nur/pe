...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pk_kadis_perubahan/edit/'.$pk_kadis_perubahan->pk_kadis_perubahan_id),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="input-group">
                        <input type="text" name="nama_pihak_pertama" value="<?=$pk_kadis_perubahan->nama_pihak_pertama ?>" id="nama_pihak_pertama" class="form-control" required readonly>
                    ...
                    <label for="jabatan_pihak_pertama">Jabatan Pihak Pertama *</label>
                        <input type="text" name="jabatan_pihak_pertama" value="<?=$pk_kadis_perubahan->jabatan_pihak_pertama ?>" id="jabatan_pihak_pertama" class="form-control">
                    </div>

                    <div class="form-group">
                    <label for="nama_pihak_kedua">Pihak Kedua *</label>
                    <div class="input-group">
                        <input type="text" name="nama_pihak_kedua" value="<?=$pk_kadis_perubahan->nama_pihak_kedua ?>" id="nama_pihak_kedua" class="form-control" required readonly>
                        <span class="input-group-btn">
                    ...
                    <label for="jabatan_pihak_kedua">Jabatan Pihak Kedua *</label>
                        <input type="text" name="jabatan_pihak_kedua" value="<?=$pk_kadis_perubahan->jabatan_pihak_kedua ?>" id="jabatan_pihak_kedua" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="date" name="tanggal_pk" value="<?=$pk_kadis_perubahan->tanggal_pk ?>" class="form-control" required>
                            </div>
                        </div>
                    <div>
