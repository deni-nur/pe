...
<head>
	...
	<title>Perjanjian Kinerja Perubahan Esselon II</title>
...
<table cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			<th colspan="3"><br>PERJANJIAN KINERJA PERUBAHAN TAHUN <?=year_date($pk_kadis_perubahan->tanggal_pk) ?></th>
		</tr>
		<tr>
		...
		<tr>
			...
			<th align="left" valign="top" ><br><?=$pk_kadis_perubahan->nama_pihak_pertama ?></th>
		</tr>
		<tr>
			<td width="5%" align="left" valign="top">Jabatan</td>
			<td width="1%" align="center" valign="top">:</td>
			<th align="left" valign="top" ><?=$pk_kadis_perubahan->jabatan_pihak_pertama ?></th>
		</tr>
		<tr>
		...
		<tr>
			<td width="5%" align="left" valign="top"><br>Nama</td>
			<td width="1%" align="center" valign="top"><br>:</td>
			<th align="left" valign="top" ><br><?=$pk_kadis_perubahan->nama_pihak_kedua ?></th>
		</tr>
		<tr>
			<td width="15%" align="left" valign="top">Jabatan</td>
			<td width="1%" align="center" valign="top">:</td>
			<th align="left" valign="top" ><?=$pk_kadis_perubahan->jabatan_pihak_kedua ?></th>
		</tr>
		<tr>
	...
	<tbody>
		<tr>
			<td width="49%" align="center">
				<br>
				<br>Pihak Kedua,
				<br><?=$pk_kadis_perubahan->jabatan_pihak_kedua ?>,
				<br>
				<br>
				<br>
				<br>
				<br>
				<br>
				<br><b><?=$pk_kadis_perubahan->nama_pihak_kedua ?></b>
			</td>
			<td></td>
			<td width="49%" align="center" >Palabuhanratu, <?=format_indo($pk_kadis_perubahan->tanggal_pk) ?>
				<br>
				<br>Pihak Pertama,
				<br><?=$pk_kadis_perubahan->jabatan_pihak_pertama ?>,
				<br>
				<br>
				<br>
				<br>
				<br>
				<br>
				<br><b><?=$pk_kadis_perubahan->nama_pihak_pertama ?></b>
			</td>
		</tr>
	</tbody>
	</tbody>
