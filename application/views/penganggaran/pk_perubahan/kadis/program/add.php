...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pk_kadis_perubahan/'.$this->uri->segment(4).'/lampiran/'.$this->uri->segment(6).'/program_pk_kadis_add'),' class="form-horizontal"');
?>
