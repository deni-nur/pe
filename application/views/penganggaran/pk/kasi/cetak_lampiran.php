...
<head>
	...
	<title>Perjanjian Kinerja Esselon IV</title>
...
<table cellspacing="0" width="100%">
	<tbody>
		<tr>
			<td width="20%">Perangkat Daerah</td>
			<td width="1%">:</td>
		...
		<tr>
			<td>Bidang / Bagian</td>
			<td>:</td>
			<td><?=$pk_kasi->bidang ?></td>
		</tr>
		<tr>
			<td>Seksi / Sub Bidang / Sub Bagian</td>
			<td>:</td>
			<td><?=$pk_kasi->sub_bidang ?></td>
		</tr>
		<tr>
			<td>Tahun Anggaran</td>
			<td>:</td>
			<td><?=year_date($pk_kasi->tanggal_pk) ?></td>
		</tr>
	</tbody>
</table>
<br>
...
<table border="1" cellspacing="0" width="100%">
	...
	<tbody>
		<?php $no=1; foreach($lampiran_pk_kasi->result() as $key => $data) { ?>
		<tr>
			<td align="center" rowspan="4" valign="top"><?=$no++; ?>.</td>
			<td rowspan="4" valign="top"><?=$data->uraian_indikator_kegiatan ?></td>
			<td rowspan="4" valign="top"><?=$data->uraian_indikator_subkeg ?></td>
...
<table cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			<td width="1%"><?=$no++; ?>.</td>
			<td width="55%"><?=$data->nama_kegiatan ?></td>
			<td width="1%">Rp.</td>
	...
	<tbody>
		<tr>
			<td width="49%" align="center">
				<br>
				<br>Pihak Kedua,
				<br><?=$pk_kasi->jabatan_pihak_kedua ?>,
				<br>
				<br>
				<br>
				<br>
				<br>
				<br>
				<br><b><?=$pk_kasi->nama_pihak_kedua ?></b>
			</td>
			<td></td>
			<td width="49%" align="center" >Sukabumi, <?=format_indo($pk_kasi->tanggal_pk) ?>
				<br>
				<br>Pihak Pertama,
				<br><?=$pk_kasi->jabatan_pihak_pertama ?>,
				<br>
				<br>
				<br>
				<br>
				<br>
				<br>
				<br><b><?=$pk_kasi->nama_pihak_pertama ?></b>
			</td>
		</tr>
	</tbody>
	</tbody>
