...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pk_kasi/'.$this->uri->segment(4).'/lampiran/'.$this->uri->segment(6).'/kegiatan_pk_kasi_add'),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="nama_kegiatan" id="nama_kegiatan" class="form-control" required readonly>
                    ...
                    <label for="pagu_kegiatan">Pagu Anggaran *</label>
                        <input type="number" name="pagu_anggaran" id="pagu_kegiatan" class="form-control">
                    </div>
