...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pk_kasi/'.$this->uri->segment(4).'/lampiran_edit/'.$lampiran_pk_kasi->lampiran_pk_kasi_id),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="input-group">
                        <input type="hidden" name="indikator_kegiatan_id" value="<?=$lampiran_pk_kasi->indikator_kegiatan_id ?>" id="indikator_kegiatan_id">
                        <input type="text" name="uraian_indikator_kegiatan" value="<?=$lampiran_pk_kasi->uraian_indikator_kegiatan ?>" id="uraian_indikator_kegiatan" class="form-control" required readonly>
                    ...
                    <div class="input-group">
                        <input type="hidden" name="indikator_subkeg_id" value="<?=$lampiran_pk_kasi->indikator_subkeg_id ?>" id="indikator_subkeg_id">
                        <input type="text" name="uraian_indikator_subkeg" value="<?=$lampiran_pk_kasi->uraian_indikator_subkeg ?>" id="uraian_indikator_subkeg" class="form-control" required readonly>
                        <span class="input-group-btn">
                    ...
                    <label for="satuan">Satuan *</label>
                        <input type="text" name="satuan" value="<?=$lampiran_pk_kasi->satuan ?>" id="satuan" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                    <label for="target">Target Tahunan *</label>
                        <input type="text" name="target_tahunan" value="<?=$lampiran_pk_kasi->target_tahunan ?>" id="target" class="form-control">
                    </div>
                    <div class="form-group">
                    <label for="triw_1">Triwulan 1 </label>
                        <input type="text" name="triwulan_1" value="<?=$lampiran_pk_kasi->triwulan_1 ?>" id="triw_1" class="form-control">
                    </div>
                    <div class="form-group">
                    <label for="triw_2">Triwulan 2 </label>
                        <input type="text" name="triwulan_2" value="<?=$lampiran_pk_kasi->triwulan_2 ?>" id="triw_2" class="form-control">
                    </div>
                    <div class="form-group">
                    <label for="triw_3">Triwulan 3 </label>
                        <input type="text" name="triwulan_3" value="<?=$lampiran_pk_kasi->triwulan_3 ?>" id="triw_3" class="form-control">
                    </div>
                    <div class="form-group">
                    <label for="triw_4">Triwulan 4 </label>
                        <input type="text" name="triwulan_4" value="<?=$lampiran_pk_kasi->triwulan_4 ?>" id="triw_4" class="form-control">
                    </div>
