...
<table cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			<th colspan="3"><br>PERJANJIAN KINERJA TAHUN <?=year_date($pk_kasi->tanggal_pk) ?></th>
		</tr>
		<tr>
		...
		<tr>
			...
			<th align="left" valign="top" ><br><?=$pk_kasi->nama_pihak_pertama ?></th>
		</tr>
		<tr>
			<td width="5%" align="left" valign="top">Jabatan</td>
			<td width="1%" align="center" valign="top">:</td>
			<th align="left" valign="top" ><?=$pk_kasi->jabatan_pihak_pertama ?></th>
		</tr>
		<tr>
		...
		<tr>
			<td width="5%" align="left" valign="top"><br>Nama</td>
			<td width="1%" align="center" valign="top"><br>:</td>
			<th align="left" valign="top" ><br><?=$pk_kasi->nama_pihak_kedua ?></th>
		</tr>
		<tr>
			<td width="15%" align="left" valign="top">Jabatan</td>
			<td width="1%" align="center" valign="top">:</td>
			<th align="left" valign="top" ><?=$pk_kasi->jabatan_pihak_kedua ?></th>
		</tr>
		<tr>
