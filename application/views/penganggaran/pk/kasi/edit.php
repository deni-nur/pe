...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pk_kasi/edit/'.$pk_kasi->pk_kasi_id),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="input-group">
                        <input type="text" name="nama_pihak_pertama" value="<?=$pk_kasi->nama_pihak_pertama ?>" id="nama_pihak_pertama" class="form-control" required readonly>
                    ...
                    <label for="jabatan_pihak_pertama">Jabatan Pihak Pertama *</label>
                        <input type="text" name="jabatan_pihak_pertama" value="<?=$pk_kasi->jabatan_pihak_pertama ?>" id="jabatan_pihak_pertama" class="form-control">
                    </div>
                    ...
                    <label for="pk_kabid_id">Nama Pihak Kedua *</label>
                        <select name="pk_kabid_id" id="pk_kabid_id" class="form-control">
                            ...
                            <option value="<?=$data->pk_kabid_id ?>" <?=$data->pk_kabid_id==$pk_kasi->pk_kabid_id ? "selected" : null ?>><?=$data->nama_pihak_pertama ?></option>
                        <?php } ?>
                        </select>
                    </div>
                    ...
                    <label for="sub_bidang">Nama Sub Bidang *</label>
                        <input type="text" name="sub_bidang" value="<?=$pk_kasi->sub_bidang ?>" id="sub_bidang" class="form-control">
                    </div>
