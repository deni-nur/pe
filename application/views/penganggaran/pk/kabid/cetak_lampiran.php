...
<table cellspacing="0" width="100%">
	<tbody>
		...
		<tr>
			...
			<td width="1%">:</td>
			<td><?=$pk_kabid->bidang ?></td>
		</tr>
		<tr>
			<td>Tahun Anggaran</td>
			<td>:</td>
			<td><?=year_date($pk_kabid->tanggal_pk) ?></td>
		</tr>
	</tbody>
</table>
<br>
...
<table border="1" cellspacing="0" width="100%">
	...
	<tbody>
		<?php $no=1; foreach($lampiran_pk_kabid->result() as $key => $data) { ?>
		<tr>
			<td align="center" rowspan="4" valign="top"><?=$no++; ?>.</td>
			<td rowspan="4" valign="top"><?=$data->uraian_indikator_program ?></td>
