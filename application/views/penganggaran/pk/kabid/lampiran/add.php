...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pk_kabid/'.$this->uri->segment(4).'/lampiran_add'),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="input-group">
                        <input type="hidden" name="indikator_program_id" id="indikator_program_id">
                        <input type="text" name="uraian_indikator_program" id="uraian_indikator_program" class="form-control" required readonly>
