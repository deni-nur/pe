...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pk_kabid/edit/'.$pk_kabid->pk_kabid_id),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="input-group">
                        <input type="text" name="nama_pihak_pertama" value="<?=$pk_kabid->nama_pihak_pertama ?>" id="nama_pihak_pertama" class="form-control" required readonly>
                    ...
                    <label for="jabatan_pihak_pertama">Jabatan Pihak Pertama *</label>
                        <input type="text" name="jabatan_pihak_pertama" value="<?=$pk_kabid->jabatan_pihak_pertama ?>" id="jabatan_pihak_pertama" class="form-control">
                    </div>

                    <div class="form-group">
                    <label for="pk_kadis_id">Nama Pihak Kedua *</label>
                        <select name="pk_kadis_id" id="pk_kadis_id" class="form-control">
                            <option value="">- Pilih -</option>
                            <?php foreach($pk_kadis->result() as $key => $data) { ?>
                            <option value="<?=$data->pk_kadis_id ?>" <?=$data->pk_kadis_id == $pk_kabid->pk_kadis_id ? "selected" : null ?>><?=$data->nama_pihak_pertama ?></option>
                        <?php } ?>
                        </select>
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <label for="bidang">Nama Bidang *</label>
                        <input type="text" name="bidang" value="<?=$pk_kabid->bidang ?>" id="bidang" class="form-control">
                    </div>
...
<div class="modal-body table-responsive">
    <table class="table table-bordered table-striped" id="table1" >
        <thead>
            ...
            <?php $no = 0; foreach($pk_kadis->result() as $key => $data) { ?>
        </thead>
        <tbody>
            <tr>
                <td width="5%"><?=++$no; ?>.</td>
                ...
                <td class="text-center">
                    ...
                    data-nama_pihak_pertama="<?=$data->nama_pihak_pertama ?>"
                    data-jabatan_pihak_kedua="<?=$data->jabatan_pihak_kedua ?>">
                        <i class="fa fa-check"></i> Select
                    </button>
                </td>
            </tr>
