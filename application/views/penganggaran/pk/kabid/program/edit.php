...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pk_kabid/'.$this->uri->segment(4).'/lampiran/'.$this->uri->segment(6).'/program_pk_kabid_edit/'.$program_pk_kabid->program_pk_kabid_id),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="input-group">
                        <input type="hidden" name="program_pk_kadis_id" value="<?=$program_pk_kabid->program_pk_kadis_id ?>" id="program_pk_kadis_id">
                        <input type="text" name="nama_program" value="<?=$program_pk_kabid->nama_program ?>" id="nama_program" class="form-control" required readonly>
                    ...
                    <label for="pagu_program">Pagu Anggaran *</label>
                        <input type="number" name="pagu_anggaran" value="<?=$program_pk_kabid->pagu_anggaran ?>" id="pagu_anggaran" class="form-control" readonly>
                    </div>
