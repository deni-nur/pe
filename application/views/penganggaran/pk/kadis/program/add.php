...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pk_kadis/'.$this->uri->segment(4).'/lampiran/'.$this->uri->segment(6).'/program_pk_kadis_add'),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <label for="pagu_program">Pagu Anggaran *</label>
                        <input type="number" name="pagu_anggaran" id="pagu_program" class="form-control">
                    </div>
