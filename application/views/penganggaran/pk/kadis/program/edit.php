...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pk_kadis/'.$this->uri->segment(4).'/lampiran/'.$this->uri->segment(6).'/program_pk_kadis_edit/'.$program_pk_kadis->program_pk_kadis_id),' class="form-horizontal"');
?>
...
<div class="box">
    <div class="box-header">
        ...
        <div class="pull-right">
            <a href="<?=base_url('portal/'.$this->uri->segment(2).'/pk_kadis/'.$this->uri->segment(4).'/lampiran/'.$this->uri->segment(6).'/program_pk_kadis') ?>" class="btn btn-warning">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="input-group">
                        <input type="hidden" name="program_id" value="<?=$program_pk_kadis->program_id ?>" id="program_id">
                        <input type="text" name="nama_program" value="<?=$program_pk_kadis->nama_program ?>" id="nama_program" class="form-control" required readonly>
                    ...
                    <label for="pagu_program">Pagu Anggaran *</label>
                        <input type="number" name="pagu_anggaran" value="<?=$program_pk_kadis->pagu_anggaran ?>" id="pagu_program" class="form-control">
                    </div>
