...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/pk_kadis/'.$this->uri->segment(4).'/lampiran_edit/'.$lampiran_pk_kadis->lampiran_pk_kadis_id),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="input-group">
                        <input type="hidden" name="sasaran_id" value="<?=$lampiran_pk_kadis->sasaran_id ?>" id="sasaran_id">
                        <input type="text" name="uraian_sasaran" value="<?=$lampiran_pk_kadis->uraian_sasaran ?>" id="uraian_sasaran" class="form-control" required readonly>
                    ...
                    <label for="indikator_sasaran_id">Indikator Kinerja *</label>
                        <input type="text" name="indikator_sasaran_id" value="<?=$lampiran_pk_kadis->uraian_indikator_sasaran ?>" id="indikator_sasaran_id" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                    <label for="satuan">Satuan *</label>
                        <input type="text" name="satuan" value="<?=$lampiran_pk_kadis->satuan ?>" id="satuan" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                    <label for="target">Target Tahunan *</label>
                        <input type="text" name="target_tahunan" value="<?=$lampiran_pk_kadis->target_tahunan ?>" id="target" class="form-control">
                    </div>
                    <div class="form-group">
                    <label for="triw_1">Triwulan 1 </label>
                        <input type="text" name="triwulan_1" value="<?=$lampiran_pk_kadis->triwulan_1 ?>" id="triw_1" class="form-control">
                    </div>
                    <div class="form-group">
                    <label for="triw_2">Triwulan 2 </label>
                        <input type="text" name="triwulan_2" value="<?=$lampiran_pk_kadis->triwulan_2 ?>" id="triw_2" class="form-control">
                    </div>
                    <div class="form-group">
                    <label for="triw_3">Triwulan 3 </label>
                        <input type="text" name="triwulan_3" value="<?=$lampiran_pk_kadis->triwulan_3 ?>" id="triw_3" class="form-control">
                    </div>
                    <div class="form-group">
                    <label for="triw_4">Triwulan 4 </label>
                        <input type="text" name="triwulan_4" value="<?=$lampiran_pk_kadis->triwulan_4 ?>" id="triw_4" class="form-control">
                    </div>
