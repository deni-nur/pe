...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/renstra/'.$this->uri->segment(4).'/ik_sasaran_renstra/'.$this->uri->segment(6).'/target_ik_sasaran_renstra/edit/'.$target_ik_sasaran_renstra->target_ik_sasaran_renstra_id),' class="form-horizontal"');
?>
                ...
                <div class="form-group">
                      ...
                      <div class="col-xs-12">
                          <table class="table table-striped" id="">
                              ...
                              <tr>
                                  <td><input type="text" class="form-control" name="tahun" value="<?=$target_ik_sasaran_renstra->tahun ?>" /></td>
                                  <td><input type='text' class='form-control' name='target' value="<?=$target_ik_sasaran_renstra->target ?>" /></td>
                                  <td><input type='text' class='form-control' name='satuan' value="<?=$target_ik_sasaran_renstra->satuan ?>" /></td>
                              </tr>
