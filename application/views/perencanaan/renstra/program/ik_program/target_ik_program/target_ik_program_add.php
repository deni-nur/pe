...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/program/'.$this->uri->segment(4).'/ik_program/'.$this->uri->segment(6).'/target_ik_program/add'),' class="form-horizontal"');
?>
