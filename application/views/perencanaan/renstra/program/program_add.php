...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/program/add'),' class="form-horizontal"');
?>
				...
				<div class="col-md-4 col-md-offset-4">
                        <div class="form-group">
                            ...
                            <select name="renstra_id" class="form-control" >
                                ...
                                <?php foreach($renstra->result() as $key => $data) { ?>
                                    <option value="<?=$data->renstra_id?>"><?=$data->sasaran ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
						...
						<div class="form-group">
                            <label>Nama Program *</label>
                             <textarea name="nama_program" class="form-control" required=""></textarea>
                        </div>
