...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/subkeg/'.$this->uri->segment(4).'/ik_subkeg/add'),' class="form-horizontal"');
?>
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div>
                    <label for="name">Indikator Sub Kegiatan *</label>
                    </div>
