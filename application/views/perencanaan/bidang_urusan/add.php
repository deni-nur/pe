...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/bidang_urusan/add'),' class="form-horizontal"');
?>
    		...
    		<div class="box-body">
    			<div class="row">
    				<div class="col-md-4 col-md-offset-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="urusan_id" class="form-control">
                                    ...
                                    <?php foreach ($urusan->result() as $key => $data) { ?>
                                        <option value="<?=$data->urusan_id ?>"><?=$data->uraian ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
    						...
    						<div class="form-group">
    							<label>Uraian *</label>
    							<textarea name="uraian_bidang_urusan" class="form-control" required></textarea>
    						</div>
