...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/dpa/'.$this->uri->segment(4).'/r_belanja/add'),' class="form-horizontal"');
?>
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
                        ...
                        <div class="form-group">
                            ...
                            <select name="a_belanja_id" class="form-control" required>
                                <option value="">- Pilih -</option>
                                <?php foreach($a_belanja->result() as $key => $data) { ?>
                                    <option value="<?=$data->a_belanja_id ?>"><?=$data->kode_rek ?> - <?=$data->nama_rek ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
