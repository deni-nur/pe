...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/tujuan/'.$tujuan->tujuan_id.'/indikator_tujuan_add'),' class="form-horizontal"');
?>
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="uraian_indikator_tujuan" class="form-control" required>
                    </div>
                    <div class="form-group">
