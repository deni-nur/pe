...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/tujuan/edit/'.$tujuan->tujuan_id),' class="form-horizontal"');
?>
	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        <label>Tujuan *</label>
                        <input type="text" name="uraian_tujuan" value="<?=$tujuan->uraian_tujuan ?>" class="form-control" required>
                    </div>
					<div class="form-group">
