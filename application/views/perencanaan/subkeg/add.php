...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/tujuan/'.$tujuan->tujuan_id.'/sasaran/'.$sasaran->sasaran_id.'/program/'.$program->program_id.'/kegiatan/'.$kegiatan->kegiatan_id.'/subkeg/add'),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_subkeg" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Nama Sub Kegiatan *</label>
                        <input type="text" name="nama_subkeg" class="form-control" required>
                    </div>
