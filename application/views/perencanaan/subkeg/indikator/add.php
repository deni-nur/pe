...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/tujuan/'.$tujuan->tujuan_id.'/sasaran/'.$sasaran->sasaran_id.'/program/'.$program->program_id.'/kegiatan/'.$kegiatan->kegiatan_id.'/subkeg/'.$subkeg->subkeg_id.'/indikator_subkeg_add'),' class="form-horizontal"');
?>
<section class="content-header">
  <h1>Indikator Sub Kegiatan PD
    <small>Indikator Sub Kegiatan PD</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i></a></li>
    <li>Perencanaan</li>
    <li>Cascading RENSTRA</li>
    <li class="active">Indikator Sub Kegiatan PD</li>
  </ol>
</section>
...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><?=ucfirst($page) ?> Indikator Sub Kegiatan PD</h3>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="uraian_indikator_subkeg" class="form-control" required>
                    </div>
                    <div class="form-group">
