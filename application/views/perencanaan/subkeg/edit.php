...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/tujuan/'.$tujuan->tujuan_id.'/sasaran/'.$sasaran->sasaran_id.'/program/'.$program->program_id.'/kegiatan/'.$kegiatan->kegiatan_id.'/subkeg/edit/'.$subkeg->subkeg_id),' class="form-horizontal"');
?>
...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><?=ucfirst($page) ?> Sub Kegiatan PD</h3>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kegiatan" value="<?=$kegiatan->nama_kegiatan ?>" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label>Kode Sub Kegiatan *</label>
                        <input type="text" name="kode_subkeg" value="<?=$subkeg->kode_subkeg ?>" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Sub Kegiatan *</label>
                        <input type="text" name="nama_subkeg" value="<?=$subkeg->nama_subkeg ?>" class="form-control" required>
                    </div>
