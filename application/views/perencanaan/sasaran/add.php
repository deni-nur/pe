...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/tujuan/'.$tujuan->tujuan_id.'/sasaran/add'),' class="form-horizontal"');
?>
	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        <label>Sasaran *</label>
                        <input type="text" name="uraian_sasaran" class="form-control">
                    </div>
