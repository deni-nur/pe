...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/rpjmd/'.$this->uri->segment(4).'/ik_sasaran_rpjmd/'.$this->uri->segment(6).'/target_ik_sasaran_rpjmd/add'),' class="form-horizontal"');
?>
