...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/tujuan/'.$tujuan->tujuan_id.'/sasaran/'.$sasaran->sasaran_id.'/program/'.$program->program_id.'/kegiatan/edit/'.$kegiatan->kegiatan_id),' class="form-horizontal"');
?>
...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><?=ucfirst($page) ?> Kegiatan PD</h3>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_kegiatan" value="<?=$kegiatan->kode_kegiatan ?>" class="form-control" required>
                    </div>
                    <div class="form-group">
