...
// form open
echo form_open(base_url('portal/'.$this->uri->segment(2).'/tujuan/'.$tujuan->tujuan_id.'/sasaran/'.$sasaran->sasaran_id.'/program/'.$program->program_id.'/kegiatan/add'),' class="form-horizontal"');
?>
